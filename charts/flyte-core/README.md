...
helm install -n flyte -f values-eks-native.yaml --create-namespace flyte flyte/flyte-core
```
...
helm diff upgrade -f values-eks-native.yaml flyte flyte/flyte-core
```

Then apply your changes:
```bash
helm upgrade -f values-eks-native.yaml flyte flyte/flyte-core
```
...
| datacatalog.image.tag | string | `"v1.0.1"` | Docker image tag |
